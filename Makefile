...
build/native_cue_rebuild.o: cpp/native_cue_rebuild.cpp cpp/native_cue_rebuild.hpp cpp/native_cue_directory.hpp cpp/exact_journal_directory.hpp cpp/hot_index_projection_log.hpp cpp/native_journal.hpp cpp/memory_episode.hpp cpp/observation.hpp cpp/digest.hpp | build
	$(CXX) $(CXXFLAGS) -Icpp -c $< -o $@
