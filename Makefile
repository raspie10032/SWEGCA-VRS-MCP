...
CORE_OBJECTS += build/region_membership_cache.o
...
build/session_observation.o: cpp/session_observation.cpp cpp/session_observation.hpp cpp/observation.hpp cpp/json.hpp cpp/digest.hpp cpp/unicode.hpp | build
	$(CXX) $(CXXFLAGS) -Icpp -c $< -o $@

build/native_session_capture.o: cpp/native_session_capture.cpp cpp/native_session_capture.hpp cpp/session_observation.hpp cpp/memory_episode.hpp cpp/owner_lock.hpp cpp/journal_files.hpp cpp/digest.hpp | build
	$(CXX) $(CXXFLAGS) -Icpp -c $< -o $@
...
build/native_endpoint_segment_file.o: cpp/native_endpoint_segment_file.cpp cpp/native_endpoint_segment_file.hpp cpp/event_vrs_inputs.hpp cpp/owner_lock.hpp | build
	$(CXX) $(CXXFLAGS) -Icpp -c $< -o $@
...
build/native_graph_node_directory.o: cpp/native_graph_node_directory.cpp cpp/native_graph_node_directory.hpp cpp/main_observation_batch.hpp cpp/main_journal_append.hpp cpp/graph_append.hpp cpp/event_vrs_inputs.hpp cpp/native_journal.hpp cpp/memory_vrs_pair.hpp cpp/owner_lock.hpp cpp/journal_files.hpp cpp/digest.hpp cpp/json.hpp | build
	$(CXX) $(CXXFLAGS) -Icpp -c $< -o $@
...
build/native_graph_numeric_append.o: cpp/native_graph_numeric_append.cpp cpp/native_graph_numeric_append.hpp cpp/main_journal_append.hpp cpp/main_observation_batch.hpp cpp/graph_append.hpp cpp/native_graph_page_file.hpp cpp/native_graph_page_map.hpp cpp/native_journal.hpp cpp/event_delta.hpp | build
	$(CXX) $(CXXFLAGS) $(NUMERIC_CXXFLAGS) -Icpp -c $< -o $@

build/native_graph_map_journal.o: cpp/native_graph_map_journal.cpp cpp/native_graph_map_journal.hpp cpp/native_graph_numeric_append.hpp cpp/native_graph_page_file.hpp cpp/main_journal_append.hpp cpp/native_journal_entry.hpp cpp/native_journal.hpp cpp/memory_vrs_pair.hpp cpp/digest.hpp cpp/json.hpp | build
	$(CXX) $(CXXFLAGS) -Icpp -c $< -o $@

build/main_observation_batch.o: cpp/main_observation_batch.cpp cpp/main_observation_batch.hpp cpp/graph_regions.hpp cpp/graph_append.hpp cpp/hot_index_pending.hpp cpp/main_operations.hpp cpp/memory_vrs_pair.hpp cpp/observation.hpp cpp/digest.hpp | build
	$(CXX) $(CXXFLAGS) $(NUMERIC_CXXFLAGS) -Icpp -c $< -o $@
...
build/native_region_binding_page.o: cpp/native_region_binding_page.cpp cpp/native_region_binding_page.hpp cpp/native_graph_page_map.hpp cpp/owner_lock.hpp cpp/journal_files.hpp | build
	$(CXX) $(CXXFLAGS) -Icpp -c $< -o $@
...
build/region_membership_cache.o: cpp/region_membership_cache.cpp cpp/region_membership_cache.hpp cpp/graph_regions.hpp cpp/hot_index.hpp cpp/memory_vrs_pair.hpp cpp/event_vrs_inputs.hpp | build
	$(CXX) $(CXXFLAGS) -Icpp -c $< -o $@
