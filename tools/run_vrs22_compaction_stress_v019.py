...
RUNTIME_PRODUCT_COMMIT = "f1ea47a"
RUNTIME_REPOSITORY_COMMIT = "f1ea47a"
RUNTIME_PYTHON = Path("/home/raspie/.local/share/swegca-vrs2-runtime-2.2-read-totals/venv/bin/python")
RUNTIME_COMMAND = RUNTIME_PYTHON.with_name("swegca-vrs2-codex")
RUNTIME_HOOK = RUNTIME_PYTHON.with_name("swegca-vrs2-hook")
RUNTIME_WHEEL = Path("/home/raspie/.local/share/swegca-vrs2-runtime-2.2-read-totals/dist/swegca_vrs_mcp-2.2.0-py3-none-any.whl")
