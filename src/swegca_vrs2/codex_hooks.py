...
def command(python, state_dir, *, module_root=None, server_name='swegca_vrs'):
    prefix = f'mcp__{server_name}__memory_'
    values = []
...
def config(python, state_dir, *, module_root=None, server_name='swegca_vrs'):
    ...
    prefix = '^' + re.escape(f'mcp__{server_name}__memory_')
