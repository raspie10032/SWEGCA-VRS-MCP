...
Vendored unchanged (core: config, observation, groups/axes/state, Wilson interval, assess, update)
from SWEGCA-Architecture `src/swegca/mosaic_evidence_accumulator.py` (commit 5901a5a, file sha256
21ea34ed0cbff51f...), Mozilla Public License 2.0 — see LICENSES/. The proposal-gating helpers
(`accumulator_gated_proposal`, audit records) that need torch and the cognitive kernel are omitted;
nothing else is altered, so decisions here are the architecture's decisions.
"""
